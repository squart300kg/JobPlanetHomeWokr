...
class TodayRecommentRecruteAdapter : RecyclerView.Adapter<TodayRecommentRecruteAdapter.CompanyAppealViewHolder>() {

    private val items: MutableList<String> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodayRecommentRecruteAdapter.CompanyAppealViewHolder {
